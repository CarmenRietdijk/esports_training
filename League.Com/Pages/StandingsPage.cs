...
namespace League.Com.Pages
{
    public class StandingsPage : PageBase
    {
        ...
        public void RemoveCookieWarning(){
    ...
    public class StandingsPageMap
    {
        ...
        public Element StageByName(string name) => Driver.FindElement(
            by: By.XPath($"//button[(contains(@class, 'button') and contains(@class, 'stage-option') and contains(@class, 'selected')) or (contains(@class, 'button') and contains(@class, 'stage-option')) and text()='{name}']"),
        ...
        //Accept button for cookie warning
        public Element AcceptButton => Driver.FindElement(By.XPath("/html/body/div[1]/div[2]/div[2]/button[2]"));
    }
}
